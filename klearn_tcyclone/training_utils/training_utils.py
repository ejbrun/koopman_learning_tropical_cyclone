...
def set_flags(FLAGS: FlagValues) -> dict:
    ...
    flag_dict = {
        ...
        "time_lag": FLAGS.time_lag,
        "tikhonov_reg": FLAGS.tikhonov_reg,
        "koopman_kernel_rank": FLAGS.koopman_kernel_rank,
        "koopman_kernel_reduced_rank": FLAGS.koopman_kernel_reduced_rank,
