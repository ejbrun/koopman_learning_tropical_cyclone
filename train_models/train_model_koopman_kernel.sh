...
do
    ...
    do
        ...
        do
            python train_model_koopman_kernel.py --model=Nystroem_RRR --koopman_kernel_num_train_stops=10 --year_range=1970,2020 --koopman_kernel_length_scale=$kk_length_scale --koopman_kernel_rank=$kk_krank --koopman_kernel_num_centers=$kk_ncenters
        done
    done
done
